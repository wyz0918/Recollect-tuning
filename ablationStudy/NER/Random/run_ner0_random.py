...
from models import BertForSpanMarkerNER0, AlbertForSpanMarkerNER
...
def main():
    ...
    if args.model_type.startswith('albert'):
        ...
        config_class, model_class, tokenizer_class = BertConfig, BertForSpanMarkerNER0, BertTokenizer
