...
from models import BertForACEBothOneDropoutSub_PLM, BertForACEBothOneDropoutSubNoNer, AlbertForACEBothOneDropoutSub
...
class ACEDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        position_ids = list(range(sub_position[0])) + [sub_position[0]] + [sub_position[0]] + list(
            ...
            range(sub_position[1] - 4, L - 4)) + [0] * (self.max_seq_length - L) + [0] * self.max_entity_length * 1
...
def main():
    ...
    if args.model_type.startswith('bert'):
        config_class, model_class, tokenizer_class = BertConfig, BertForACEBothOneDropoutSub_PLM, BertTokenizer
    else:
