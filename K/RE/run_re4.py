...
from models import BertForACEBothOneDropoutSub4, BertForACEBothOneDropoutSubNoNer, AlbertForACEBothOneDropoutSub4
...
class ACEDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for x_idx, obj in enumerate(entry['examples']):
            ...
            mention_pos.append((pos_index[0], pos_index[1], pos_index[2],pos_index[3]))
...
def main():
    ...
    if args.model_type.startswith('bert'):
        config_class, model_class, tokenizer_class = BertConfig, BertForACEBothOneDropoutSub4, BertTokenizer
    else:
        config_class, model_class, tokenizer_class = AlbertConfig, AlbertForACEBothOneDropoutSub4, AlbertTokenizer
